...
void Time_evolution(Array<cdouble,1>* V, Array<cdouble,1>* force, Array<double,1>* k) {
	...
	// cout<<"1\n"<<*nlin<<endl;
	Single_time_step_EULER(V, nlin, k, dt/2);						// u1: Goto the mid point
	// cout<<"euler\n"<<*V<<endl;
